...
:: Android packaging
set AND_CERT_NAME="FluidSolver"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\FluidSolver.p12
...
set IOS_PROVISION=cert\FluidSolver.mobileprovision
...
set APP_ID=air.FluidSolver

:: Output packages
set DIST_PATH=dist
set DIST_NAME=FluidSolver
