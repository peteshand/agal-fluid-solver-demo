package animators
{
	 ...
	 */
	public class PointCloudAnimator extends AnimatorBase implements IAnimator
	{
		private var _pointCloudAnimationSet:PointCloudAnimationSet;
		 ...
		 *
		 * @param pointCloudAnimationSet The animation data set containing the vertex animations used by the animator.
		 */
		public function PointCloudAnimator(pointCloudAnimationSet:PointCloudAnimationSet)
		{
			super(pointCloudAnimationSet);
			
			_pointCloudAnimationSet = pointCloudAnimationSet;
			_numPoses = pointCloudAnimationSet.numPoses;
			_blendMode = pointCloudAnimationSet.blendMode;
		}
		...
		{
			return new PointCloudAnimator(_pointCloudAnimationSet);
		}
